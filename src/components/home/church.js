					...
					return (
						<InView as='section' triggerOnce onChange={inView => this.handleView(inView)}>
							<section
								...
								style={{
									background: `${
										this.props.menuState ? `linear-gradient( rgba(0, 0, 0, .5), rgba(0, 0, 0, .5) ), ` : ``
									} url(${data.home.publicURL})`,
									backgroundSize: 'cover',
									backgroundPosition: 'center',
								}}
							>
								<div
									className={`church-manage-title text-white text-center ${
										this.state.view ? `fade-in-up` : `fade-in-hidden`
									}`}
								>
