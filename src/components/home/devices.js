							...
							<div className='col-lg-4 offset-lg-2 col-sm-8 offset-sm-2'>
								<InView as='div' triggerOnce onChange={inView => this.handleDescView(inView)}>
									<div className={this.state.descView ? `fade-in-left` : `fade-in-hidden`}>
										...
										<p>
											No matter what your role in church, having access to the people and information that’s most
											important to you can help immensely. Being able to contact the right people, ensure people are
											followed up and tasks are actioned right away can help big churches feel less impersonal and small
											churches feel better resourced.
										</p>
										<p>
											Whether you love your Apple, Android or Windows device, we’ve got you covered with full featured
											apps for when you’re not at a desk. And if you’re a Mac, PC or Chromebook user you’re all set,
											just fire up your web browser and you’ll have access to the same info and features available on
											your mobile device.
										</p>
									</div>
								</InView>
							...
							<div className={`row apple-google-play ${this.state.appStore ? `fade-in-up` : `fade-in-hidden`}`}>
								...
								<div className='col-md-1 offset-md-3 text-center'>
									<a href='https://play.google.com/store/apps/details?id=com.ucareapp.app'>
										<img className='button-center' src={data.googleStore.publicURL} alt='Get it on Google Play' />
									</a>
								</div>
							</div>
						</InView>
