				...
				<InView as='div' triggerOnce onChange={inView => this.handleSecondView(inView)}>
					<div className={`row text-center my-5 up ${this.state.secondView ? `fade-in-up` : `fade-in-hidden`}`}>
						...
						<div className='col-md-4'>
							...
							<h6>
								Plan services, organize teams, confirm volunteers and learn new songs. We’ve got the tool that will
								simplify it all.
							</h6>
						</div>
					</div>
				...
				<InView as='div' triggerOnce onChange={inView => this.handleThirdView(inView)}>
					<div className={`row text-center my-5 down ${this.state.thirdView ? `fade-in-up` : `fade-in-hidden`}`}>
						<div className='col-md-4'>
							...
							<h6>
								Reporting trends, tracking finances and managing facilities can quickly overload the best admins, why
								not let UCare take the load?
							</h6>
						</div>
						<div className='col-md-4'>
							<div className='ministry-circle'>
						...
						<div className='col-md-4'>
							...
							<h6>
								Make it easy for people to find & join groups. Give leaders the tools they need to communicate & quickly
								report attendance.
							</h6>
						</div>
					</div>
