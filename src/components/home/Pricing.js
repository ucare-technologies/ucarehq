									...
									<InView as='div' triggerOnce onChange={inView => this.handleView(inView)}>
										<div className={`row ${this.state.view ? `fade-in-up` : `fade-in-hidden`}`} id='pricing'>
											...
											<div className={`col-xl-5 col-md-12 mt-5 price-calc`}>
												...
												<p>
													The monthly costs for UCare are just 10c per person, so for example if your church has 500
													people regularly attending then UCare will cost only $50 each month.&nbsp;(
												...
												<p>
													If you have <span>{this.state.values[0] > 2000 ? '2000+' : this.state.values[0]}</span> people
													in your church
												</p>
												<div>
														...
														{this.state.values[0] / 10 > 200 ? (
															<output
																dangerouslySetInnerHTML={{
																	__html: `Please contact <a href="support@ucarehq.com" /> support@ucarehq.com</a> for information about our volume discounts.`,
																}}
															...
															<div className='container m-auto'>
																<div className='row'>
																	<div className='col-sm-12 p-0'>
																		<h6>
																			Your cost would be <span>{`$${this.state.values[0] / 10} / month`}</span>
																		</h6>
																	</div>
																</div>
															</div>
