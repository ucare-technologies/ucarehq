  ...
  render() { 
    return ( 
      <StaticQuery
        ...
        `}
        render={ data => (
          <InView as="div" onChange={inView => this.handleIntersection(inView)}>
            <nav className={ `navbar navbar-expand-lg fixed-top text-center ${this.state.isTop ? 'navbar-trans' : 'bg-light'}` }>
