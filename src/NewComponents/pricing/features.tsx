...
function AL(
  name: string,
  other: React.ReactNode = `Add on`,
  lighthouse: React.ReactNode = <Yes />
) {
  ...
  return [
    ...
    },
    {
      ...
      features: [
        ...
        Values(
          `Send SMS directly from UCare to the parent/guardian`,
          `Add on`,
          <NA />,
          `Add on`,
          `Add on`
    ...
    },
    {
      ...
      features: [
        GLS(
          `Automate multi-step actions based on activity triggers`,
          `3 automations included`
        ),
        GLS(
          `Automate multi-step actions based on polling conditions`,
          `3 automations included`
        ),
      ],
    },
    {
      ...
      features: [
        AL(
          `Manage unlimited services across multiple locations`,
          `5 campuses included`
        ),
        AL(
          `Support multiple service and rehearsal times for each service`,
          `5 campuses included`
        ),
        GL(
        ...
        GSLS(
          `Live Services to facilitate team communication and service timings`
        ),
      ],
    },
    {
