...
const CheckInFeature: React.FC = () => (
  <Feature
    to="check-in-child-safety"
    className="child"
    label="Check-in &amp; Child Safety"
  >
    <ChildIcon />
  </Feature>
)
...
const StoresFeature: React.FC = () => (
  <Feature
    to="online-stores"
    className="online-stores"
    label="Online Stores &amp; POS"
  >
    <OnlineStoresIcons />
  </Feature>
)
