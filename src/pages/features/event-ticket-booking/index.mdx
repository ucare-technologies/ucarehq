...
- Publish **event pages on your website or the UCare portal**.
- Or easily embed **event pages on your website**.
- **Publish an event calendar** to your website or the UCare portal.
...
- The mobile app is supported on iOS 10+ and Android 5+.

<ThreeUp>
	Enter an event name, time, location and description. Add your ticket types and publish your event. Send out promo
	email and grab the app to quickly validate tickets at the door. The set up options will grow as you need and we’re
