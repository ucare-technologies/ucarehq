...
- **Issue refund,** both cash, Card & Direct debit.
...
<ThreeUp>
	Select a payment service, add payment forms to your website, and you're ready to go. The setup options will grow as
	you need and we’re there to guide you with every step.
</ThreeUp>
