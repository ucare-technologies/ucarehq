		...
		this.state = {
			...
			qa: [
				...
				},
				{
					...
					A: 'None, simply subscribe after your 30-day trial ends to keep your account.',
				},
				{
				...
				},
				{
					...
					A: 'Whether you want a backup or you have decided to close your account you can export your data from UCare.',
				},
				{
				...
				},
				{
					...
					A:
						'Our average up-time is over 99.95%, less than 20 minutes unplanned down time in a month. We have a <a href="/sla" /> Service Level Agreement of 99.9%,</a> if we ever fail to meet this a credit will be applied to your account.',
				},
				{
				...
				<div
					...
					style={{
						background: `linear-gradient( rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45) ), url(${
							this.props.data.signup.publicURL
						})`,
					...
					<div className='row signup-form'>
						<div className='col-md-8 user-input-form'>
							<form onSubmit={this.handleSubmit}>
								...
								<button type='submit' className='btn btn-success trial'>
						...
						<div className='col-md-4'>
							<ul className='list-group'>
								...
								<li>
									<img src={this.props.data.checkMark.publicURL} alt='check mark' />
									&nbsp;&nbsp; Unlimited users
								</li>
								<li>
									<img src={this.props.data.checkMark.publicURL} alt='check mark' />
					...
					<div className='row faq'>
						<div className='text-center'>
							<div className='faq-title'>
								...
								<p>
									We’re here to help. If you run into any problems at all, feel free to use the help button to contact
									us.
								</p>
							</div>
